          ...
          <div className="about-page-hero">
            <div className="about-page-hero-text">
              ...
              <h1 className="about-page-heading" style={{ fontFamily: "var(--font-jakarta), sans-serif" }}>
                Building intelligent<br />things people actually<br />want to use.
              </h1>
          ...
          <div className="about-page-body">
            <div className="about-page-section">
              ...
              <div className="about-page-prose">
                ...
                <p>
                  I work best in the intersection between design and engineering, where a clear mental model of the
