...
export default function ContactPage() {
  return (
    <>
      <Nav />
      <main id="main-content" className="min-h-[80svh] flex items-center justify-center px-[clamp(20px,5vw,60px)] pt-[calc(64px+clamp(40px,8vh,80px))] pb-[clamp(60px,10vh,100px)]">
