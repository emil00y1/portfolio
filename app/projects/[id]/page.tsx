...
function ProjectHeroImage({ id }: { id: string }) {
    ...
    return (
      <div
        style={{
          width: "100%",
          height: "100%",
          background: "linear-gradient(135deg, #1a1208 0%, #2d1f0e 50%, #3d2a14 100%)",
          display: "flex",
    ...
    return (
      <div
        style={{
          width: "100%",
          height: "100%",
          background: "linear-gradient(135deg, #e8e2db 0%, #d4c9bd 100%)",
          display: "flex",
          flexDirection: "column",
          alignItems: "center",
          justifyContent: "center",
      ...
      >
        ...
        <span style={{ fontSize: 12, color: "#A8967F", letterSpacing: "0.1em" }}>allegade10.dk</span>
      </div>
    );
  }
  ...
  return (
    ...
    >
      ...
      <span style={{ fontSize: 11, color: "#C4B5A5", letterSpacing: "0.15em" }}>NDA · Details on request</span>
    </div>
  );
}
